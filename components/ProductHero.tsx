        ...
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-block px-6 py-2 bg-mint/20 border border-mint/30 rounded-full mb-6"
            >
              <span className="text-white text-sm font-light">₹35 per bottle</span>
            </motion.div>
            ...
            >
              ...
              <span className="text-[10px] tracking-[0.4em] uppercase text-white/50">Premium Masala Mojito</span>
            </motion.div>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-3 px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm tracking-[0.3em] uppercase font-light hover:border-mint/40 transition-all cursor-pointer rounded-lg"
            >
